...
I **hate** writing CV's, but I understand why it's required, hence why it's now in a <a href="https://github.com/davidclarke-au/markdown-cv"><i class="fas fa-code-branch"></i> Code Repository</a>. Simple to update, modern, backed up and demonstates many technical skills right off the bat.
...
Come on, we covered this above... OSINT. Hit up my <a href="https://blog.david-clarke.id.au">   <i class="fab fa-tumblr"></i></a> <br> then we can talk <i class="fas fa-record-vinyl"></i> or <i class="fas fa-beer"></i> or <i class="fas fa-flag-checkered"></i> or <i class="fas fa-campground"></i> <i class="fas fa-hiking"></i>
