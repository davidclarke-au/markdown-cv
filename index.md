...
**_Generative and Agentic AI_** in both day to day work to streamline data analysis, incident BLUF and Red Team/Threat Actor applications <i class="fab fa-codepen"></i> and also building and creating apps via Lovable and Replit <i class="fas fa-laptop-code"></i>

**_Cloud Security_**, with preference to AWS <i class="fab fa-aws"></i>

**_MEDR Technologies_** with preference to CrowdStrike <i class="fas fa-crow"></i> and Palo Alto Networks Cortex <i class="fa-solid fa-tornado"></i></i>
